...
public class FLACEncoder {
     ...
     */
    public boolean addSamples(int[] samples, int count) throws UnfinishedBlockError {
        boolean added = false;
...
//                if(unfinishedBlockRemaining <=0) {
                if(unfinishedBlockRemaining <=0) {
                    throw new UnfinishedBlockError("Unfinished block remaining " + unfinishedBlockRemaining);
