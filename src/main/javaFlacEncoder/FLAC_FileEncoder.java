...
public class FLAC_FileEncoder {
    ...
    private void adjustConfigurations(AudioFormat format) {
        ...
        //int blockSize = streamConfiguration.getMaxBlockSize();
        /*streamConfiguration = new StreamConfiguration(channels, blockSize, blockSize,
    ...
    private Status openStream() {
        ...
        boolean result = flac.setStreamConfiguration(streamConfiguration);
    ...
    public Status encode(File inputFile, File outputFile) {
        ...
        } catch (UnfinishedBlockError unfinishedBlockError) {
            //unfinishedBlockError.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
            System.out.println("Error " + unfinishedBlockError.getMessage());
            status = Status.INTERNAL_ERROR;
        }
